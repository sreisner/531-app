...
let CycleGrid = ({ classes, sessionMeta, onBeginSessionClick }) => {
...
CycleGrid = withStyles(styles)(CycleGrid);

class CycleGridContainer extends Component {
...
export default withRouter(CycleGridContainer);
